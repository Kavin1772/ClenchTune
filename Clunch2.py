        ...
        while True:
            ...
            if CLENCH_RANGE[0] <= sensor_value <= CLENCH_RANGE[1]:
                ...
                if len(clench_times) == 2:
                    ...
                    last_action_time = current_time  # ✅ update after skip
                    clench_times.clear()

            # === Single clench pause/resume ===
            if len(clench_times) == 1:
                time_since_first = current_time - clench_times[0]
                if time_since_first > CLENCH_WINDOW:
                    if current_time - last_action_time >= ACTION_COOLDOWN:
                        if is_playing:
                        ...
                        last_action_time = current_time  # ✅ update after pause/resume
                        clench_times.clear()
